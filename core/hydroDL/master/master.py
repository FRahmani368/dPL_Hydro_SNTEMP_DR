...
from core.hydroDL import utils
...
def loadData(args, readX=True, readY=True ):
    ...
    y = df.getDataObs(args,
        doNorm=args['optData']['doNorm'][1], rmNan=args['optData']['rmNan'][1])    # doNorm=optData['doNorm'][1]     optData['rmNan'][1]
    c = df.getDataConst(args,
